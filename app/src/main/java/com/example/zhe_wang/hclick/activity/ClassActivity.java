...
public class ClassActivity extends AppCompatActivity
    ...
    private String url = Url.url + "classAndroid";
    ListView mListView;
    /**
    ...
    private void toInternet() {
        ...
        final Handler myHandler = new Handler() {
            public void handleMessage(Message msg) {
                //读取obj发送过来的消息
                Log.d("ClassActivity", "msg.obj:" + msg.obj);

                ClassList[] classLists = new Gson().fromJson((String) msg.obj, ClassList[].class);

                Log.d("ClassActivity", "classLists:" + classLists);
                int[] id = new int[classLists.length];
                String[] time = new String[classLists.length];
                for (int i = 0 ; i< classLists.length ; i++){
                    id[i] = Integer.parseInt(classLists[i].id);
                    time[i] = classLists[i].time;

                    Log.d("ClassActivity"," id: " +id[i] + " time: "+time[i]);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            intent.setClass(ClassActivity.this, SettingActivity.class);
            startActivity(intent);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent();
            intent.setClass(ClassActivity.this, ClassActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_record) {
            Intent intent = new Intent();
            intent.setClass(ClassActivity.this, RecordActivity.class);
            startActivity(intent);
