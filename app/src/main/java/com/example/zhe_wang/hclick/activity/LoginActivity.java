...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String url = Url.url+"loginAndroid";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mAccountSignUpButton = (Button) findViewById(R.id.to_signup_button);
    ...
    private void toInternet(){
        ...
        final Handler myHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                try {
                    ...
                    Url.USER_ID = jsonObject.getString("id");
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                String result = login.doGet(new String[]{"account", "password"}, new String[]{mEmailView.getText().toString().trim(), mPasswordView.getText().toString().trim()});
